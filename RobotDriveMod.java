 ...
 * driving.
 */
public class RobotDriveMod implements MotorSafety {
   ...
   *        motor.
   */
  public RobotDriveMod(final int leftMotorChannel, final int rightMotorChannel) {
   ...
   */
  public RobotDriveMod(final int frontLeftMotor, final int rearLeftMotor, final int frontRightMotor,
   ...
   */
  public RobotDriveMod(SpeedController leftMotor, SpeedController rightMotor) {
   ...
   *        the robot.
   */
  public RobotDriveMod(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
